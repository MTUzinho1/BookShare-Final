...
function renderDashboardAlerts(payload) {
  ...
  $$('[data-route]', container).forEach(button => button.onclick = () => navigate(button.dataset.route));
}
...
function bindPageActions() {
  ...
  $("#librarian-profile-shortcut")?.addEventListener("click", () => navigate("configuracoes"));
